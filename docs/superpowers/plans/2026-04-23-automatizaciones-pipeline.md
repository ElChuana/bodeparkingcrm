...
```bash
cd backend
DATABASE_URL="postgresql://bodeparking:***CREDENCIAL-ELIMINADA***@monorail.proxy.rlwy.net:35865/bodeparkingcrm" npx prisma db push
DATABASE_URL="postgresql://bodeparking:***CREDENCIAL-ELIMINADA***@monorail.proxy.rlwy.net:35865/bodeparkingcrm" npx prisma generate
```
...
```bash
cd backend
DATABASE_URL="postgresql://bodeparking:***CREDENCIAL-ELIMINADA***@monorail.proxy.rlwy.net:35865/bodeparkingcrm" node -e "
