...
**Railway URL:** `postgresql://bodeparking:***CREDENCIAL-ELIMINADA***@monorail.proxy.rlwy.net:35865/bodeparkingcrm`
...
```bash
DATABASE_URL="postgresql://bodeparking:***CREDENCIAL-ELIMINADA***@monorail.proxy.rlwy.net:35865/bodeparkingcrm"
