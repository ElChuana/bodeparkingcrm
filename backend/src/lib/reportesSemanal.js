...
async function guardarReporteSemanal(gerenteId, contenido) {
  ...
  return prisma.reporteSemanal.upsert({
    where: { gerenteId_fechaInicio: { gerenteId, fechaInicio } },
    create: { gerenteId, fechaInicio, fechaFin, contenido },
