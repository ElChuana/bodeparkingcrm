...
const { crearPlan, agregarCuota, editarCuota, obtenerPlan, registrarPago, registrarPagoArriendo, cuotasAtrasadas } = require('../controllers/pagosController')
...
router.put('/cuotas/:id', editarCuota)
